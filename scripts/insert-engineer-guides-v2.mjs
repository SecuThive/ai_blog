...
const guides = [
  // ── Linux / Shell ────────────────────────────────────────
  {
    title: 'find 명령어 실전 완전 가이드',
    slug: 'linux-find-command-guide',
    summary: '파일 검색부터 조건 필터링, exec 연계 삭제·변환까지 find 명령어를 현업에서 바로 쓸 수 있도록 정리합니다.',
    category: 'Linux / Shell',
    tags: ['find', '파일검색', 'linux', 'shell', '실전'],
    difficulty: 'beginner',
...
- 대용량 디렉터리는 \`find ... | head -20\` 으로 먼저 샘플 확인`,
  ...
  {
    title: 'awk · sed 실전 — 로그 파싱과 텍스트 변환',
    slug: 'awk-sed-practical-guide',
    summary: '로그 분석, CSV 변환, 설정 파일 패치 등 현업에서 자주 쓰는 awk·sed 패턴을 한 곳에 정리합니다.',
    category: 'Linux / Shell',
    tags: ['awk', 'sed', '로그분석', '텍스트처리', 'linux'],
...
\`\`\``,
  ...
  {
    title: 'tmux 완전 가이드 — 세션·창·패널 관리',
    slug: 'tmux-complete-guide',
    summary: '원격 서버 작업의 필수 도구 tmux. 세션 유지, 창 분할, 설정 커스터마이징까지 실무 중심으로 정리합니다.',
    category: 'Linux / Shell',
    tags: ['tmux', '터미널', '세션관리', '원격작업', 'productivity'],
    difficulty: 'beginner',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'macOS'],
    author: 'Nodelog',
    content: `## tmux가 필요한 이유
...
5. \`Ctrl+b ]\` 로 붙여넣기`,
  ...
  {
    title: 'rsync로 안전한 파일 동기화 및 백업',
    slug: 'rsync-backup-sync-guide',
    summary: 'rsync의 핵심 옵션부터 원격 서버 동기화, 증분 백업 자동화까지 실무 중심으로 설명합니다.',
    category: 'Linux / Shell',
    tags: ['rsync', '백업', '동기화', '파일전송', 'linux'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'macOS'],
    author: 'Nodelog',
    content: `## rsync 기본 구조
...
\`\`\``,
  ...
  // ── Docker / 컨테이너 ──────────────────────────────────────
  {
    title: 'Docker Compose 실전 — 멀티 컨테이너 앱 구성',
    slug: 'docker-compose-practical-guide',
    summary: 'docker-compose.yml 작성부터 서비스 의존성, 볼륨, 환경변수, 헬스체크까지 실무 패턴을 정리합니다.',
    category: 'Docker / 컨테이너',
    tags: ['docker', 'docker-compose', '컨테이너', '멀티서비스', 'devops'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS'],
    author: 'Nodelog',
    content: `## docker-compose.yml 기본 구조
...
\`\`\``,
  ...
  {
    title: '실행 중인 컨테이너 디버깅 — docker exec, logs, inspect',
    slug: 'docker-container-debugging',
    summary: '컨테이너가 예상대로 동작하지 않을 때 사용하는 디버깅 명령어와 패턴을 정리합니다.',
    category: 'Docker / 컨테이너',
    tags: ['docker', '디버깅', '컨테이너', 'logs', 'inspect'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS'],
    author: 'Nodelog',
    content: `## 컨테이너 상태 확인
...
\`\`\``,
  ...
  // ── Git / CI·CD ────────────────────────────────────────────
  {
    title: 'git rebase · cherry-pick 실전 가이드',
    slug: 'git-rebase-cherry-pick-guide',
    summary: '커밋 히스토리 정리, 브랜치 동기화, 특정 커밋만 가져오기까지 rebase와 cherry-pick을 실무 관점에서 정리합니다.',
    category: 'Git / CI·CD',
    tags: ['git', 'rebase', 'cherry-pick', '커밋정리', '협업'],
    difficulty: 'advanced',
...
- 부득이하게 force push할 경우: \`git push --force-with-lease\` 사용 (남이 중간에 push했으면 거절됨)`,
  ...
  {
    title: 'GitHub Actions로 Docker 이미지 빌드 및 레지스트리 배포 자동화',
    slug: 'github-actions-docker-build-push',
    summary: 'GitHub Actions 워크플로우로 Docker 이미지를 빌드하고 GHCR 또는 Docker Hub에 푸시하는 CI/CD 파이프라인을 구성합니다.',
    category: 'Git / CI·CD',
    tags: ['github-actions', 'docker', 'ci-cd', 'ghcr', '자동배포'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu'],
    author: 'Nodelog',
    content: `## 전체 흐름
...
\`cache-from: type=gha\` / \`cache-to: type=gha,mode=max\` 설정만으로 GitHub Actions 캐시를 활용합니다. 레이어 변경이 없으면 재빌드하지 않아 빌드 시간이 크게 단축됩니다.`,
  ...
  // ── 네트워킹 / 서버 ────────────────────────────────────────
  {
    title: 'ss · netstat · tcpdump으로 네트워크 상태 진단',
    slug: 'network-diagnostic-ss-netstat-tcpdump',
    summary: '포트 리스닝 확인, 연결 상태 조회, 패킷 캡처까지 리눅스 네트워크 진단의 핵심 도구를 실무 중심으로 정리합니다.',
    category: '네트워킹 / 서버',
    tags: ['네트워크', 'ss', 'netstat', 'tcpdump', '진단'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'RHEL'],
    author: 'Nodelog',
    content: `## ss — 현대적인 소켓 통계
...
\`\`\``,
  ...
  {
    title: 'DNS 레코드 완전 가이드 — A, CNAME, MX, TXT 설정과 dig 활용',
    slug: 'dns-records-dig-guide',
    summary: 'DNS 레코드 타입별 용도와 설정 방법, dig 명령으로 DNS 문제를 직접 진단하는 방법을 정리합니다.',
    category: '네트워킹 / 서버',
    tags: ['DNS', 'dig', '레코드', '네트워크', '도메인'],
    difficulty: 'beginner',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'macOS'],
    author: 'Nodelog',
    content: `## DNS 레코드 타입
...
- **CDN 사용 시**: Cloudflare 프록시 레코드는 TTL이 자동 관리됩니다.`,
  ...
  // ── OS / 시스템 ────────────────────────────────────────────
  {
    title: '디스크 관리 실전 — lsblk, df, du, fdisk, LVM',
    slug: 'disk-management-lsblk-df-du',
    summary: '디스크 용량 확인부터 파티션 생성, LVM 볼륨 확장까지 서버 디스크 관리의 핵심 명령어를 정리합니다.',
    category: 'OS / 시스템',
    tags: ['디스크', 'lsblk', 'df', 'du', 'LVM', '파티션'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'RHEL'],
    author: 'Nodelog',
    content: `## 현재 상태 파악
...
\`\`\``,
  ...
  {
    title: 'journalctl 완전 활용 — systemd 로그 조회와 분석',
    slug: 'journalctl-log-analysis-guide',
    summary: 'journalctl로 시스템 로그를 조회·필터링·분석하는 방법을 실무 시나리오와 함께 정리합니다.',
    category: 'OS / 시스템',
    tags: ['journalctl', '로그', 'systemd', '모니터링', '디버깅'],
    difficulty: 'beginner',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'RHEL'],
    author: 'Nodelog',
    content: `## 기본 조회
...
\`/etc/systemd/journald.conf\`에서 \`SystemMaxUse=500M\`, \`MaxRetentionSec=2week\`으로 영구 설정 가능합니다.`,
  },

  {
    title: '메모리·스왑 관리 — free, vmstat, 스왑 설정',
    slug: 'memory-swap-management-guide',
    summary: '서버 메모리 상태 파악, OOM 원인 분석, 스왑 파일 생성 및 스왑니스 조정까지 실무 중심으로 정리합니다.',
    category: 'OS / 시스템',
    tags: ['메모리', '스왑', 'OOM', 'vmstat', 'free', 'linux'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'RHEL'],
    author: 'Nodelog',
    content: `## 메모리 현황 파악
...
- 기본값 60은 데스크탑용으로 설계됨`,
  ...
  // ── 보안 설정 ──────────────────────────────────────────────
  {
    title: 'SSH 서버 보안 강화 — 설정 최적화와 fail2ban',
    slug: 'ssh-hardening-fail2ban',
    summary: 'SSH 기본 설정 강화, 키 기반 인증 전용 전환, fail2ban 브루트포스 차단까지 서버 첫 세팅 시 꼭 해야 할 보안 작업을 정리합니다.',
    category: '보안 설정',
    tags: ['SSH', 'fail2ban', '보안', '서버보안', '인증'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'RHEL'],
    author: 'Nodelog',
    content: `## sshd_config 보안 설정
...
\`\`\``,
  ...
  {
    title: 'openssl 실전 — 인증서 생성, 확인, 변환',
    slug: 'openssl-certificate-guide',
    summary: '자체 서명 인증서 생성, CSR 발급, 인증서 정보 확인, PEM/PFX 형식 변환까지 openssl 핵심 명령어를 정리합니다.',
    category: '보안 설정',
    tags: ['openssl', '인증서', 'TLS', 'SSL', '보안'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'macOS'],
    author: 'Nodelog',
    content: `## 인증서 정보 확인
...
\`\`\``,
  ...
  // ── 클라우드 ────────────────────────────────────────────────
  {
    title: 'AWS CLI 설치·설정과 핵심 명령어 완전 가이드',
    slug: 'aws-cli-setup-and-commands',
    summary: 'AWS CLI v2 설치부터 프로파일 설정, EC2·S3·IAM 자주 쓰는 명령어까지 실무 중심으로 정리합니다.',
    category: '클라우드',
    tags: ['AWS', 'AWS-CLI', 'EC2', 'S3', '클라우드'],
    difficulty: 'beginner',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'macOS'],
    author: 'Nodelog',
    content: `## 설치
...
\`\`\``,
  ...
  {
    title: 'Terraform 기초 — 인프라를 코드로 관리하기',
    slug: 'terraform-basics-infrastructure-as-code',
    summary: 'Terraform 설치부터 AWS EC2 인스턴스 프로비저닝, 상태 관리, 실무 워크플로우까지 초보자 관점으로 정리합니다.',
    category: '클라우드',
    tags: ['Terraform', 'IaC', 'AWS', '인프라', 'DevOps'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'macOS'],
    author: 'Nodelog',
    content: `## Terraform이란?
...
상태 파일(\`terraform.tfstate\`)은 반드시 원격 저장소(S3 + DynamoDB 잠금)로 관리하세요. git에 커밋하면 절대 안 됩니다.`,
  ...
  // ── 데이터베이스 ────────────────────────────────────────────
  {
    title: 'PostgreSQL 인덱스 최적화 — 느린 쿼리 진단과 인덱스 전략',
    slug: 'postgresql-index-optimization',
    summary: 'EXPLAIN ANALYZE로 느린 쿼리를 찾고, 적절한 인덱스 타입을 선택하여 성능을 개선하는 방법을 실무 중심으로 정리합니다.',
    category: '데이터베이스',
    tags: ['PostgreSQL', '인덱스', '쿼리최적화', '성능', 'SQL'],
    difficulty: 'advanced',
    os_compat: ['Ubuntu', 'Debian', 'CentOS'],
    author: 'Nodelog',
    content: `## 느린 쿼리 찾기
...
\`\`\``,
  ...
  {
    title: 'Redis 기초 실전 — 캐시, 세션, 메시지 큐 활용',
    slug: 'redis-basics-practical-guide',
    summary: 'Redis 설치부터 String·Hash·List·Sorted Set 자료구조 활용, 캐시 전략, TTL까지 실무 중심으로 정리합니다.',
    category: '데이터베이스',
    tags: ['Redis', '캐시', 'NoSQL', '세션', '메시지큐'],
    difficulty: 'beginner',
    os_compat: ['Ubuntu', 'Debian', 'CentOS'],
    author: 'Nodelog',
    content: `## 설치
...
\`/etc/redis/redis.conf\`에서 \`requirepass yourpassword\` 설정을 권장합니다.
...
\`\`\``,
  ...
  {
    title: 'MySQL/MariaDB 백업 · 복원 완전 가이드',
    slug: 'mysql-backup-restore-guide',
    summary: 'mysqldump를 활용한 논리 백업과 복원 절차, 자동화 스크립트, 바이너리 로그 기반 시점 복원까지 정리합니다.',
    category: '데이터베이스',
    tags: ['MySQL', 'MariaDB', '백업', '복원', 'DBA'],
    difficulty: 'intermediate',
    os_compat: ['Ubuntu', 'Debian', 'CentOS', 'RHEL'],
    author: 'Nodelog',
    content: `## mysqldump — 논리 백업
...
async function insertGuides() {
  ...
  console.log(`\n완료: ${success}개 삽입, ${skipped}개 중복 건너뜀, ${failed}개 실패`);
}
