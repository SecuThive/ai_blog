      ...
      <div className="container">
        ...
        <div className="footer-col footer-brand">
          ...
          <div className="footer-social">
            <a href="https://twitter.com" target="_blank" rel="noopener" className="icon-btn" aria-label="Twitter">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" />
              </svg>
            </a>
            <a href="https://github.com/SecuThive" target="_blank" rel="noopener" className="icon-btn" aria-label="GitHub">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
              </svg>
            </a>
            <a href="/rss.xml" className="icon-btn" aria-label="RSS">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
        ...
        <div className="footer-col">
          <h5>주제</h5>
          <ul>
            <li><a href="/category/AI & 자동화">AI 자동화</a></li>
            <li><a href="/category/IT 트렌드">IT 트렌드</a></li>
            <li><a href="/category/개발">개발</a></li>
            <li><a href="/category/툴 리뷰">리뷰</a></li>
          </ul>
        </div>
