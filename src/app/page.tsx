...
const TOPICS = [
  { glyph: '01', name: 'AI 도구', href: '/category/AI%20%26%20%EC%9E%90%EB%8F%99%ED%99%94' },
  { glyph: '02', name: '에이전트', href: '/category/AI%20%26%20%EC%9E%90%EB%8F%99%ED%99%94' },
  { glyph: '03', name: '개발', href: '/category/%EA%B0%9C%EB%B0%9C' },
  { glyph: '04', name: '툴 리뷰', href: '/category/%ED%88%B4%20%EB%A6%AC%EB%B7%B0' },
  { glyph: '05', name: 'IT 트렌드', href: '/category/IT%20%ED%8A%B8%EB%A0%8C%EB%93%9C' },
  { glyph: '06', name: '리서치', href: '/category/IT%20%ED%8A%B8%EB%A0%8C%EB%93%9C' },
  { glyph: '07', name: '에세이', href: '/' },
  { glyph: '08', name: '인터뷰', href: '/' },
];
