...
const SECTIONS = [
  ...
  ['5. 사용자의 권리', '사용자는 자신의 정보에 대한 열람, 정정, 삭제, 처리 정지를 언제든 요청할 수 있으며 privacy@nodelog.kr 로 요청 시 7일 이내에 처리됩니다.'],
        ...
        <div className="container" style={{ maxWidth: 780 }}>
          ...
          <div style={{ marginTop: 56, padding: 24, border: '1px solid var(--line-1)', borderRadius: 12, background: 'var(--bg-2)', display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            <div style={{ fontSize: 13.5, color: 'var(--text-2)' }}>
              이 정책에 대해 궁금한 점이 있다면 <a style={{ color: 'var(--acc-blue)' }} href="mailto:privacy@nodelog.kr">privacy@nodelog.kr</a> 로 문의해주세요.
            </div>
          </div>
        </div>
      </section>
