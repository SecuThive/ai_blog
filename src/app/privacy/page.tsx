...
const SECTIONS = [
  ['1. 수집하는 정보', '뉴스레터 구독을 신청한 경우 이메일 주소만 수집합니다. 사이트 이용 분석과 광고 게재를 위해 익명화된 페이지뷰·체류 시간·기기/브라우저 정보가 수집되며, 이름·연락처 등 직접적인 개인 식별 정보는 수집하지 않습니다.'],
  ['2. 정보의 사용 목적', '수집한 이메일은 뉴스레터 발송과 발송 동의 이력 기록 외 용도로 사용되지 않습니다. 분석 데이터는 콘텐츠 추천, 사이트 품질 개선, 광고 게재 및 성과 측정에 사용됩니다.'],
  ['3. 보관 기간', '뉴스레터 구독 이메일은 구독 해지 시 14일 이내에 영구 삭제됩니다. 분석 데이터는 90일이 지나면 통계 집계 후 원본이 삭제됩니다. 광고·분석 쿠키의 보관 기간은 각 제공업체(Google 등)의 정책을 따릅니다.'],
  ['4. 제3자 제공 및 처리 위탁', '당사는 사용자의 개인정보를 판매하지 않습니다. 다만 서비스 운영을 위해 다음의 신뢰할 수 있는 사업자에게 처리를 위탁하거나, 해당 사업자가 자체 쿠키를 통해 익명화된 이용 데이터를 처리할 수 있습니다 — 광고: Google AdSense, 분석: 페이지뷰 측정 도구, 메일 발송: 뉴스레터 인프라. 각 사업자는 자체 개인정보처리방침에 따라 데이터를 처리합니다.'],
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <div style={{ fontFamily: 'var(--ff-mono)', fontSize: 11.5, color: 'var(--text-4)', letterSpacing: '0.06em', marginTop: 18 }}>
            최종 업데이트 · 2026.06.02 · 적용 시작일 2026.06.02
          </div>
        </div>
      </section>
