...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    category: 'content',
    q: '글은 어떻게 작성되나요?',
    a: '수집 → 신호 점수화 → 초고 생성 → 편집자 검토 → 발행 → 피드백 학습의 6단계를 거칩니다. 자세한 다이어그램은 편집자 페이지의 운영 방식 섹션을 참고하세요.',
  },
  {
    category: 'newsletter',
    q: '뉴스레터는 어떻게 구독하나요?',
  ...
  },
  {
    ...
    a: 'thive8564@gmail.com 로 알려주시면 24시간 내에 검토 후 정정합니다. 정정된 내용은 글 상단에 명시되며, 어떤 부분이 어떻게 수정되었는지 기록됩니다.',
  },
];
